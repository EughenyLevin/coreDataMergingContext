...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    LEUserController *uc = [LEUserController new];
    ...
    /*
    LEUser *newUser = [NSEntityDescription insertNewObjectForEntityForName:@"LEUser" inManagedObjectContext:self.context];
    newUser.firstName = @"Eugheny";
    newUser.lastName = @"Levin";
    */
    return YES;
}
...
- (NSPersistentContainer *)persistentContainer {
    ...
    @synchronized (self) {
        if (_persistentContainer == nil) {
            _persistentContainer = [[NSPersistentContainer alloc] initWithName:@"Laba11CoreData"];
